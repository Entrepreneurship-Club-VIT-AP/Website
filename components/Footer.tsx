...
export default function Footer() {
  return (
    <motion.footer
      ...
      style={{
        background:
          "linear-gradient(to top, rgba(0,0,0,1) 0%, rgba(2, 2, 2,0.3) 100%)",
      }}
    >
      <motion.div className="flex flex-col text-lg justify-center items-center gap-2">
        <motion.p className="justify-self-center">
          Entrepreneurship Club, VIT-AP.
        </motion.p>
        <motion.p className="justify-self-center">
          © 2025 All rights reserved
        </motion.p>
        <motion.p className="justify-self-center">
          Made with ❤️ by the Technical Team
        </motion.p>
      </motion.div>
