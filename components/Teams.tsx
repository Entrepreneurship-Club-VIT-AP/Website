...
export default function Teams() {
  ...
  return (
    ...
    >
      <motion.div className="flex flex-col gap-8 items-center justify-center w-full p-10">
        <motion.h2
        ...
        >
          {teams.map((team, index) => (
            ...
            >
              ...
              <motion.h3 className="text-xl font-bold text-orange-500 mb-3">
                {team.name}
              </motion.h3>

              <motion.p className="text-orange-300/80 text-sm leading-relaxed">
                {team.description}
              </motion.p>
