    ...
    >
      ...
      <motion.section className="text-center mb-16" variants={itemVariants}>
        ...
        >
          ...
          We&apos;d love to hear from you. Let&apos;s turn your entrepreneurial
      ...
      <motion.section className="text-center mt-16" variants={itemVariants}>
        ...
        >
          ...
          <p className="text-gray-300 mb-6">
            Join the Entrepreneurship Club of VIT-AP and turn your ideas into
            reality. Connect with like-minded innovators and start building your
            future today.
          </p>
          <motion.a
            href="/"
