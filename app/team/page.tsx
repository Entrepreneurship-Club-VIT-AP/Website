      ...
      >
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            We&apos;re not just one team &mdash; we&apos;re an ecosystem of
            passionate individuals working together to build something
            extraordinary.
          </motion.p>
        </motion.section>
        ...
        <motion.section className="max-w-7xl mx-auto" ref={membersRef}>
          <AnimatePresence mode="wait">
            ...
            >
              <motion.h2 className="text-3xl font-bold text-orange-500 text-center mb-8">
              ...
              <motion.div
                ...
                variants={containerVariants}
              >
                {teamsData.teams[activeTab].members.map(
                  (member, memberIndex) => {
                    const CardContent = (
                      <motion.div
                      ...
                      >
                        ...
                        >
                          ...
                          <div className="absolute bottom-0 left-0 right-0 p-4 text-center">
                            <motion.h3 className="text-xl font-bold text-white mb-1 drop-shadow-lg">
                              {member.name}
                            </motion.h3>

                            <motion.p className="text-orange-300 text-sm font-medium drop-shadow-lg">
                              {member.role}
                            </motion.p>
                          </div>
                        </motion.div>
        ...
        <motion.section className="text-center mt-20" variants={itemVariants}>
          ...
          >
            ...
            <p className="text-orange-300/90 mb-6">
              Each team plays a crucial role in our success. Find your passion,
              contribute your skills, and be part of building the future of
              entrepreneurship at VIT-AP.
            </p>
            <motion.a
              href="/contact"
